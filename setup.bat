...
echo {"user_id":"%USERID%","server_jar_path":"%converted_path%", "channel_id":"%CHANNEL_ID%", "server_address":"%SERVER_ADDRESS%", "rcon_port":"%RCON_PORT%", "rcon_pass":"%RCON_PASS%"} > settings.json
